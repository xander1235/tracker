    ...
    <section className="auth">
      <div className="auth-shell">
        <div className="auth-pane">
          ...
          <p className="auth-sub">Sign in to manage categories and keep your tracking organized.</p>
          <form className="auth-card form compact" onSubmit={onSubmit}>
            ...
            <div className="auth-actions">
              <span className="muted">Don't have an account? <Link to="/signup">Sign up</Link></span>
            </div>
          </form>
        </div>
        <div className="auth-hero" aria-hidden="true">
          ...
          >
            ...
            <circle cx="620" cy="140" r="140" fill="url(#g2)" />
            <circle cx="160" cy="440" r="180" fill="url(#g2)" />
            <g stroke="url(#g1)" strokeWidth="2" fill="none" opacity=".7">
